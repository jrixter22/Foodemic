...
public class Careful : MonoBehaviour {
	...
	void Start () {
		...
		if (Application.loadedLevelName == "Max City Level") {
		...
		} else if (Application.loadedLevelName == "Cindi Beach Level") {
			if (gameObject.transform.position.z > 0) {
				odd = true;
				targetNum = RandomEven();
				if(gameObject.transform.position.z == 16 && gameObject.transform.position.x > 0){
					spawnLocal = 1;
				}else if(gameObject.transform.position.z == 18 && gameObject.transform.position.x > 0){
					spawnLocal = 3;
				}else if(gameObject.transform.position.z == 20 && gameObject.transform.position.x > 0){
					spawnLocal = 5;
				}else if(gameObject.transform.position.z == 16 && gameObject.transform.position.x < 0){
					spawnLocal = 7;
				}else{
					spawnLocal = 9;
				}
				...
				odd = false;
				targetNum = RandomOdd();
				if(gameObject.transform.position.z == -5.5 && gameObject.transform.position.x < 0){
					spawnLocal = 2;
				}else if(gameObject.transform.position.z == -7.5 && gameObject.transform.position.x < 0){
					spawnLocal = 4;
				}else if(gameObject.transform.position.z == -9.5 && gameObject.transform.position.x < 0){
					spawnLocal = 6;
				}else if(gameObject.transform.position.z == -5.5 && gameObject.transform.position.x > 0){
					spawnLocal = 8;
				}else{
					spawnLocal = 10;
				}
			}
		} else if (Application.loadedLevelName == "Lucy Park Level") {
			if (gameObject.transform.position.x < 0) {
				odd = true;
				targetNum = RandomEven();
				if(gameObject.transform.position.z < -1){
